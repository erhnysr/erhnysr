...
|Project                                                                          |Description                                                      |
|---------------------------------------------------------------------------------|-----------------------------------------------------------------|
|[republic-ai-node](https://github.com/erhnysr/republic-ai-node)                  |Full validator + GPU mining suite                                |
|[republic-discord-bot](https://github.com/erhnysr/republic-discord-bot)          |Validator monitoring Discord bot                                 |
|[republic-job-orchestrator](https://github.com/erhnysr/republic-job-orchestrator)|Multi-validator job distribution                                 |
|[republic-points-tracker](https://github.com/erhnysr/republic-points-tracker)    |Real-time validator leaderboard                                  |
|[hermes-turkish-locale](https://clawhub.ai/erhnysr/turkish-locale)               |Turkish Locale Skill Pack — news, market data & Telegram delivery|
...
- ✅ **Nous Research** — Turkish Locale Skill Pack contributor (PR #1118)
- ✅ **Nous Research** — Core fix contributor, cherry-picked by @teknium1 (PR #1822)
